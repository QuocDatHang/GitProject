...
function addNewProduct() {
    ...
    if (productName != '' && productName != ' ') {
        ...
        count++;
        document.getElementById('counter').innerHTML = count + ' Products';
...
function deleteProduct(product_name) {
    ...
    count--;
    if (count == 0) {
        document.getElementById('counter').innerHTML = count + ' Product'
    }
    else
        document.getElementById('counter').innerHTML = count + ' Products'
}
...
function editProduct(product_name) {
    document.getElementById(product_name).innerHTML = `<input type='text' id='newName' onblur='rename("${product_name}",this)' placeholder='Nhập tên mới'></input>`;
